	...
	[
		...
		[ // choice
			...
			[ // choice-effect
				...
				"they are poisoned. If they live while just 3 players live, evil wins (even if you are dead).",
		...
		[ // double-choice
			...
			[ // double-choice-effect
				...
				"they are poisoned until dusk. All but 1 of them learn they were targeted.",
				"in the morning they play roshambo. The loser dies. If they tie, they all die."
			]
		],
		[ // conditional
			[ // conditional-power
				...
				"if there are 5 or more players dead,",
				"if you are \"mad\" that the Demon player is evil,",
				"the 1st time the Demon is nominated by an evil player,",
				"when an evil player nominates a Demon,",
				"you learn 1 player that is permanently poisoned. If they are executed or killed,",
				"you live & the nominator dies. If a player chooses you at night,",
